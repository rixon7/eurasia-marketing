        ...
        <div className="mx-auto flex max-w-[1280px] flex-col items-center justify-between gap-4 px-4 py-6 sm:flex-row sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:justify-end">
            {[
              ...
              {
                href: 'https://www.instagram.com/eurasiamarketinguk/',
                label: 'INSTAGRAM',
                brand: '#E1306C',
                icon: (
              ...
              {
                href: 'https://facebook.com/eurasiamarketing',
                label: 'FACEBOOK',
                brand: '#1877F2',
                icon: (
              ...
              <a
                ...
                className="group flex w-24 flex-col items-center justify-center gap-2 rounded-xl border border-[color-mix(in_srgb,var(--brand)_25%,transparent)] bg-[color-mix(in_srgb,var(--brand)_12%,var(--surface-glass))] py-4 text-foreground-faint transition-all hover:-translate-y-0.5 hover:border-[color-mix(in_srgb,var(--brand)_55%,transparent)] hover:bg-[color-mix(in_srgb,var(--brand)_22%,var(--surface-glass))] hover:shadow-[0_8px_24px_-8px_var(--brand)]"
              >
                {icon}
                <span className="font-mono text-[10px] font-semibold tracking-widest transition-colors group-hover:text-foreground">{label}</span>
              </a>
            ))}
          </div>
        </div>
